<%@ Page Language="C#" AutoEventWireup="True" Codebehind="servRegPredict.aspx.cs" Inherits="CloudSAS.servRegPredict" %>
        ...
        <script type="text/javascript">
            ...
            AmCharts.ready(function () {
				...
				*/
                ...
                graph.balloonText = "[[category]]发布服务[[value]]项";
                graph.bullet = "square";
                chart.addGraph(graph);
                ...
                graph.balloonText = "预测[[category]]有[[value]]项服务发布";
                graph.bullet = "round";
                chart.addGraph(graph);
